...
list.addEventListener('click', e => {
    ...
    const botonGuardar = e.target.closest('.edit-icon').parentElement.parentElement.children[2].children[0].children[1];
    const svgEditar = e.target.closest('.edit-icon').parentElement.parentElement.children[2].children[0].children[0];
    console.log(botonGuardar);
    //quitar el readonly
    const removeReadonly = (input, boton2) => {
    ...
    if (e.target.closest('.edit-icon')) {
        ...
        removeReadonly(inputEditNumber, botonEditar);
        removeReadonly(inputEditName, botonEditar);
...
window.onload = () => {
    list.innerHTML = localStorage.getItem('LISTACONTACTO');
}
